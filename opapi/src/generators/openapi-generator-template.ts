...
const view = {
  ...
  apiRelativeToRoot: './',
  licenseInfo: 'This is the license information',
  operations: [
    {
      ...
      operation: [
        {
          notes: 'This is my operation notes',
          summary: 'Summary of my operation',
          allParams: [
            {
              paramName: 'param1',
              dataType: 'string',
...
export function renderTemplate() {
  return mustache.render(template, view, undefined, { escape: (t) => t })
}
