...
async function getPackage() {
    if (_packageRef === undefined) {
        ...
        if (_packageRef === undefined) {
            ...
            params.setName("redpanda");
            params.setVersion("1.7.3");
            params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3JlZHBhbmRhLWRhdGEvcmVkcGFuZGEiLCJ2ZXJzaW9uIjoiMS43LjMifX0="), c => c.charCodeAt(0)));
