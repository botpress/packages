...
describe('Number validations', () => {
  ...
  it('should be possible to describe both maximum and minimum date', (assert) => {
  ...
  it("should include custom error message for both maximum and minimum if they're passed", (assert) => {
