...
async function getPackage() {
    if (_packageRef === undefined) {
        ...
        if (_packageRef === undefined) {
            ...
            params.setName("clickhouse");
            params.setVersion("3.10.0");
            params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2NsaWNraG91c2UvY2xpY2tob3VzZSIsInZlcnNpb24iOiIzLjEwLjAifX0="), c => c.charCodeAt(0)));
