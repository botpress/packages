...
declare class $RefParser {
  ...
  public dereference(schema: string | $RefParser.JSONSchema): $RefParser.JSONSchema;
  public dereference(schema: string | $RefParser.JSONSchema, options: $RefParser.Options): $RefParser.JSONSchema;
  public dereference(baseUrl: string, schema: string | $RefParser.JSONSchema, options: $RefParser.Options): $RefParser.JSONSchema;
  ...
  public static dereference(schema: string | $RefParser.JSONSchema): $RefParser.JSONSchema;
  public static dereference(schema: string | $RefParser.JSONSchema, options: $RefParser.Options): $RefParser.JSONSchema;
  public static dereference(baseUrl: string, schema: string | $RefParser.JSONSchema, options: $RefParser.Options): $RefParser.JSONSchema;
