...
describe('Arrays and array validations', () => {
  it('should be possible to describe a simple array', (assert) => {
  ...
  it('should be possible to describe a simple array with any item', (assert) => {
  ...
  it('should be possible to describe a string array with a minimum and maximum length', (assert) => {
  ...
  it('should be possible to describe a string array with an exect length', (assert) => {
  ...
  it('should be possible to describe a string array with a minimum length of 1 by using nonempty', (assert) => {
  ...
  it('should be possible do properly reference array items', (assert) => {
  ...
  it('should include custom error messages for minLength and maxLength', (assert) => {
  ...
  it('should include custom error messages for exactLength', (assert) => {
  ...
  it('should not include errorMessages property if none are passed', (assert) => {
    const jsonSchema: JSONSchema7Type = {
      type: 'array',
      minItems: 5,
      maxItems: 10,
  ...
  it("should not include error messages if it isn't explicitly set to true in References constructor", (assert) => {
